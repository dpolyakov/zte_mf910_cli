define(function() {
    var config = {
        ...
        NETWORK_DISPLAY_MODE: [ {
            ...
            name: 'DC-HSPA+;UMTS;WCDMA;HSDPA;HSPA;HSUPA;HSPA+;DC-HSPA',
            value: '3G'
        }, {
            name: 'LTE',
            value: '4G'
...
define([ 'underscore', 'jquery', 'config/config'], function(_, $, config) {
    ...
    function getWifiBasic() {
        ...
        function prepare(params, isPost) {
            ...
            requestParams.cmd = "m_ssid_enable,RadioOff," + wpapsk + "MAX_Station_num,"+
                "SSID1,AuthMode,HideSSID,MAX_Access_num,EncrypType," +
                "m_SSID,m_AuthMode,m_HideSSID,m_MAX_Access_num,m_EncrypType,wifi_band,m_wifi_band";
    ...
    function setWifiBasicMultiSSIDSwitch2() {
        ...
        function prepare(params) {
            ...
            if(params.wifi_band == "ab"){
                requestParams.m_wifi_band = "a";
                requestParams.wifi_band = "b";
                requestParams.m_band_enable = "1";

            }else{
                requestParams.wifi_band = params.wifi_band;
                requestParams.m_band_enable = "0";
            }
    ...
    function getStatusInfo(){
        if (timerInfo.isLoggedIn === undefined) {
            ...
            return {
                ...
                batteryVolPercent:timerInfo.batteryVolPercent,
                ...
                connectWifiSignal:timerInfo.connectWifiSignal,
                passwd_changed:timerInfo.passwd_changed,
                first_login_prompt:timerInfo.first_login_prompt
            };
        }
	 ...
	 */
    var timerQueryString = [ "modem_main_state", "pin_status","loginfo","new_version_state","current_upgrade_state",
        "is_mandatory","signalbar","network_type", "network_provider", "ppp_status","sta_ip_status","RadioOff","station_mac", "battery_charging",
        "battery_vol_percent", "battery_pers","spn_display_flag","plmn_display_flag","spn_name_data","spn_b1_flag","spn_b2_flag","realtime_tx_bytes","realtime_rx_bytes","ex_wifi_rssi",
        "realtime_tx_thrpt","realtime_rx_thrpt","EX_SSID1","passwd_changed","first_login_prompt"];
    var loginTimerQueryString = ["EX_wifi_profile","m_ssid_enable",
        "simcard_roam", "lan_ipaddr","realtime_time",
    ...
    if(config.HAS_SMS){
        $.merge(timerQueryString, ["sms_received_flag", "sts_received_flag", 'sms_unread_num']);
    }
    /**
     * 定时刷新临时回调列表
...
//        }
        ...
        timerInfo.connectWifiSignal = data.ex_wifi_rssi;
        timerInfo.passwd_changed = data.passwd_changed;
        timerInfo.first_login_prompt = data.first_login_prompt;
        ...
        timerInfo.batteryVolPercent = data.battery_vol_percent;
    ...
    function getSIMPhoneBookCapacity() {
        ...
        return {
            ...
            maxNameLen:parseInt(data.pbm_sim_max_name_len, 10),
            maxNumberLen:parseInt(data.pbm_sim_max_number_len, 10)
        };
    }
    ...
    function getLoginData(){
        ...
        function prepare(params, isPost) {
            var requestParams = {};
            requestParams.isTest = isTest;
            requestParams.cmd = "modem_main_state,puknumber,pinnumber,psw_fail_num_str,login_lock_time,pin_save_flag";
            requestParams.multi_data = 1;
            return requestParams;
        }
        ...
        function deal(data) {
            if (data) {
                ...
                data.psw_fail_num_str = data.psw_fail_num_str < 0 ? 0 : data.psw_fail_num_str;
...
//                currentLoginStatus = undefined;
    ...
    function enterPIN() {
        ...
        function prepare(params, isPost){
            ...
            obj.pin_save_flag = params.pin_save_flag;
            return obj;
        }
    ...
    function getPinData(){
        ...
        function prepare(params, isPost) {
            var requestParams = {};
            requestParams.isTest = isTest;
            requestParams.cmd = "pinnumber,pin_status,puknumber,pin_save_flag";
            requestParams.multi_data = 1;
            return requestParams;
        }
    ...
    function getWifiAdvance() {
        ...
        function prepare(params, isPost) {
            var requestParams = {};
            requestParams.isTest = isTest;
            requestParams.cmd = "m_ssid_enable,wan_active_band,m_band_enable,WirelessMode,CountryCode,Channel,HT_MCS,wifi_band,wifi_11n_cap,m_WirelessMode,m_CountryCode,m_Channel,m_wifi_band,m_wifi_11n_cap,MAX_Station_num,MAX_Access_num,m_MAX_Access_num";
            requestParams.multi_data = 1;
            return requestParams;
        }
    ...
    function setWifiAdvanceGuest() {
        ...
        function prepare(params) {
            ...
            if(params.m_station){
                requestParams.m_MAX_Access_num = params.m_station;
                requestParams.MAX_Access_num = params.station;
            }else{
                requestParams.MAX_Access_num = params.station;
            }
            if(config.WIFI_BAND_SUPPORT){
        ...
        function prepare(params, isPost) {
            var requestParams = {
                ...
                cmd : "wifi_coverage,m_ssid_enable,imei,web_version,wa_inner_version,hardware_version,MAX_Access_num," +
                    ...
                    "mac_address,msisdn,LocalDomain,wan_ipaddr,ipv6_wan_ipaddr,ipv6_pdp_type,pdp_type,ppp_status,sim_imsi,rssi,rscp,lte_rsrp,lte_snr,lte_band,network_type,WPAPSK1_encode,AuthMode",
                multi_data : 1
            };
            return requestParams;
        }
    ...
    function getWifiRange() {
        ...
        function prepare(params, isPost) {
            var requestParams = {};
            requestParams.isTest = isTest;
            requestParams.cmd = "wifi_coverage,auto_start_device";
            requestParams.multi_data = 1;
            return requestParams;
        }
        ...
        function deal(data) {
            if (data) {
                ...
                result.auto_start_device = data.auto_start_device;
                return result;
            } else {
                return unknownErrorObject;
            }
    ...
    function deleteHotspot() {
        ...
        function prepare(params) {
            ...
            for (var i = 0; i < apList.length; i++) {
                ...
                var index = parseInt(idIndex / 5, 10);
                wifi["profile" + index].push(hotspotStr);
            }
    ...
    /**
     * 获取锁频段
     * @method getLockBandType
     */
    function getLockBandType(){
        return doStuff(arguments, {}, prepare, deal, null, false);
    ...
    /**
     * 设置锁频段
     * @method setLockBandType
     */
    function setLockBandType(){
        return doStuff(arguments, {}, prepare, deal, null, true);
        ...
        function prepare(params) {
            return {
                ...
                lte_band_lock:params.lockBandType
            };
        }
    ...
    function getNetworkStatusInfo(){
        ...
        function prepare(params, isPost) {
            var requestParams = {
                isTest: isTest,
                cmd : "profile_name,m_profile_name,network_provider,wan_ipaddr,lte_rssi,lac_code,cell_id,"
                    +"lte_band,lte_rsrq,prefer_dns_auto,standby_dns_auto,enodeb_id,tx_power,dns_mode,"+
                    "prefer_dns_manual,standby_dns_manual,lte_pci,ipv6_prefer_dns_auto,ipv6_standby_dns_auto,"+
                    "ipv6_wan_ipaddr,ipv6_pdp_type,ipv6_prefer_dns_manual,ipv6_standby_dns_manual,pdp_type,ipv6_dns_mode,network_type,rssi,rscp,lte_rsrp",
                multi_data : 1
            };
            return requestParams;
        }
        ...
        function deal(data) {
            if (data) {
                ...
                var type_3g = ["UMTS", "HSDPA", "HSUPA", "HSPA", "HSPA+", "DC", "DC-HSPA", "DC-HSPA+"];
                var type_4g = ["LTE"];
                ...
                return {
                    profileName: data.m_profile_name || data.profile_name,//apn
                    networkOperator: data.network_provider,//运营商
                    ipAddress: data.wan_ipaddr,//IP
                    signal: signal,//信号强度
                    LACCode: data.lac_code,
                    PCI: data.lte_pci,
                    LTEFrequency: data.lte_band,
                    RSRP: data.lte_rsrp,
                    RSRQ: data.lte_rsrq,
                    primaryDNSAuto: data.prefer_dns_auto,
                    secondDNSAuto: data.standby_dns_auto,
                    eNodeBId: data.enodeb_id,
                    UETxPower: data.tx_power,
                    DNSMode: data.dns_mode,
                    primaryDNSManual: data.prefer_dns_manual,
                    secondDNSManual: data.standby_dns_manual,
                    IPV6PrimaryDNSAuto: data.ipv6_prefer_dns_auto,
                    IPV6SecondDNSAuto: data.ipv6_standby_dns_auto,
                    IPV6IPAddress: data.ipv6_wan_ipaddr,//IP
                    ipv6PdpType: data.ipv6_pdp_type,
                    IPV6PrimaryDNSManual: data.ipv6_prefer_dns_manual,
                    IPV6SecondDNSManual: data.ipv6_standby_dns_manual,
                    pdpType : data.pdp_type,
                    IPV6DNSMode: data.ipv6_dns_mode
                };
            } else {
                return unknownErrorObject;
            }
    ...
    function getRedirectNotice(){
        ...
        function prepare(params, isPost) {
            var requestParams = {
                isTest: isTest,
                cmd : "redirect_flag,upgrade_remind,sms_remind",
                multi_data : 1
            };
            return requestParams;
        }
        ...
        function deal(data) {
            if (data) {
                return {
                    ...
                    upgradeRemind: data.upgrade_remind,
                    smsRemind: data.sms_remind
                };
            } else {
                return unknownErrorObject;
            }
    ...
    /**
     * 设置跳转标识
     * @method setRedirectNotice
     */
    function setRedirectNotice(){
        return doStuff(arguments, {}, prepare, deal, null, true);

        function prepare(params) {
            if(params.noticeType=="newVersion"){
                return {
                    isTest:isTest,
                    goformId:"SET_REMIND_FLAG",
                    upgrade_remind: ""
                };
            }else if(params.noticeType=="newMessage"){
                return {
                    isTest:isTest,
                    goformId:"SET_REMIND_FLAG",
                    sms_remind: 0
                };
            }else if(params.noticeType=="redirect"){
                return {
                    isTest:isTest,
                    goformId:"SET_REMIND_FLAG",
                    redirect_flag: params.redirect_flag?params.redirect_flag:""
                };
            }
        }
    ...
    function getLanguageSetting(){
        ...
        function deal(data) {
            if (data) {
                return {
                    languageFlag: data.matched_language_flag
                };
            } else {
                return unknownErrorObject;
            }
    ...
    function setLanguageSetting(){
        ...
        function prepare(params) {
            return {
                isTest:isTest,
                goformId:"SET_MATCHED_LANGUAGE_FLAG",
                matched_language_flag: params.languageType
            };
        }
    ...
    function setAutoStartUp() {
        ...
        function prepare(params, isPost) {
            var requestParams = {};
            requestParams.goformId = "AUTO_START_DEVICE";
            requestParams.isTest = isTest;
            requestParams.auto_start_device = params.plugInStartUp;
            return requestParams;
        }
    ...
    function getWPSStatus() {
        ...
        function deal(data) {
            if (data) {
                return {
                    wifi_wps_config: data.wifi_wps_config
                };
            } else {
                return unknownErrorObject;
            }
     ...
     * @method setWPSStatus
     */
    function setWPSStatus() {
        return doStuff(arguments, {}, prepare, deal, null, true);

        function prepare(params, isPost) {
            var requestParams = {};
            requestParams.isTest = isTest;
            requestParams.wifi_wps_config = params.wifi_wps_config;
            requestParams.goformId = "SWITCH_WPS";
            return requestParams;
        }
    ...
    /**
     * 设置基本的home页面wifi信息(SSID1)
     * @method setHomeWifiBasic(SSID1)
     * @param {Object} JSON 参数对象
     * @return {Object}
     */
    function setHomeWifiBasic() {
        doStuffAndCheckServerIsOnline(arguments, prepare, deal);

        function prepare(params) {
            var requestParams = {
                goformId : "SET_WIFI_MULTI_BAND_SETTINGS",
                isTest : isTest,
                m_ssid_enable: params.multi_ssid_enable,
            //    m_band_enable : params.m_band_enable,
                wifi_multi_band_set : params.wifi_multi_band_set
            };

             if(params.wifi_band == "a" || params.wifi_band == "b"){
                 requestParams.m_band_enable = "0";
             }else{
                 requestParams.m_band_enable = "1";
             }

            if(params.wifi_band == "a" || params.wifi_band == "b" || params.wifi_band == "ab"){
                requestParams.security_mode = params.authMode;
                requestParams.ssid = params.ssid;
                if(params.wifi_band == "b"){
                    requestParams.wifi_band = "b";
                }else if(params.wifi_band == "ab"){
                    requestParams.wifi_band = "b";
                }else{
                    requestParams.wifi_band = "a";
                }

                requestParams.cipher = params.cipher;
                if(params.authMode == "WPAPSKWPA2PSK" || params.authMode == "WPA2PSK" ) {
                    requestParams.security_shared_mode = params.cipher;
                    requestParams.passphrase = config.PASSWORD_ENCODE ?Base64.encode(params.passPhrase): params.passPhrase;
                }
           ...
           if(params.wifi_band == "ab") {
                requestParams.m_SSID = params.ssid;
                requestParams.m_wifi_band = "a";
                requestParams.m_AuthMode = params.authMode;
                requestParams.m_cipher = params.cipher;
                if(params.authMode == "WPAPSKWPA2PSK" || params.authMode == "WPA2PSK") {
                    requestParams.m_EncrypType = params.cipher;
                    requestParams.m_WPAPSK1 = config.PASSWORD_ENCODE ? Base64.encode(params.passPhrase) : params.passPhrase;
                }
                else {
                    requestParams.m_EncrypType = "NONE";
                }
     ...
     * @method disconnect
     */
    function disconnectNetworkAuto() {
        var callback = arguments[1];
        return doStuff(arguments, {}, prepare, deal, null, true);
        ...
        function prepare(params, isPost) {
            ...
            requestParams.isTest = isTest;
            requestParams.notCallback = true;
            requestParams.goformId = "DISCONNECT_NETWORK_AUTO";
            return requestParams;
        }

        function deal(data) {
            if (data.result == "success") {
                addCallback(checkDisconnectStatusAuto);
            } else {
                callback({
                    result : false
                });
        ...
        function checkDisconnectStatusAuto(data) {
            if (data.ppp_status == "ppp_disconnecting") {
                timerInfo.connectStatus = "ppp_disconnecting";
            } else if (data.ppp_status == "ppp_disconnected") {
                removeCallback(checkDisconnectStatusAuto);
                timerInfo.connectStatus = "ppp_disconnected";
                callback({
                    result : true,
                    status : timerInfo.connectStatus
    ...
    function setChangePassword() {
        ...
        function prepare(params, isPost) {
            var requestParams = {};
            requestParams.isTest = isTest;
            requestParams.goformId = "SET_LOGIN_MARK";
            if(typeof params.passwd_changed != 'undefined' ){
                requestParams.passwd_changed = params.passwd_changed;
            }
            if(typeof params.first_login_prompt != 'undefined' ){
                requestParams.first_login_prompt = params.first_login_prompt;
            }
            return requestParams;
        }
	...
	return {
        ...
        getLockBandType: getLockBandType,
        setLockBandType: setLockBandType,
        getNetworkStatusInfo: getNetworkStatusInfo,
        getRedirectNotice: getRedirectNotice,
        setRedirectNotice: setRedirectNotice,
        getLanguageSetting: getLanguageSetting,
        setLanguageSetting: setLanguageSetting,
        setAutoStartUp: setAutoStartUp,
        turnOffDevice: turnOffDevice,
        getWPSStatus: getWPSStatus,
        setWPSStatus: setWPSStatus,
        setHomeWifiBasic: setHomeWifiBasic,
        setWifiBasicMultiSSIDSwitch2:setWifiBasicMultiSSIDSwitch2,
        getNetWorkProvider:getNetWorkProvider,
        getAPProcess: getAPProcess,
        disconnectNetworkAuto: disconnectNetworkAuto,
